...
export default function BookingBox() {
  ...
  const searchLocation = async (query, type) => {
    ...
    try {
      ...
      else setDropSuggestions(places);
    } catch (err) {
      console.log(err);
    }
  };
      ...
      <div className="bg-[#0f172a]/90 backdrop-blur-xl border border-green-500/20 p-6 rounded-3xl shadow-2xl w-full max-w-md text-white">
        ...
        <div className="bg-[#020617] border border-gray-700 rounded-2xl px-4 py-4 mb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-300">Trip Type</span>
            </div>
            <select
              value={tripType}
            ...
            >
              <option value="oneway" className="text-black">One Way</option>
              <option value="round" className="text-black">Round Trip</option>
        ...
        <div className="bg-[#020617] border border-gray-700 rounded-2xl px-4 py-4 mb-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <span className="text-lg">🚗</span>
              <span className="text-sm text-gray-300">Select Vehicle</span>
            </div>
            <select
              value={carType}
              ...
              className="bg-transparent outline-none text-white text-sm"
            >
              <option value="wagonr" className="text-black">WagonR / Swift</option>
              <option value="ertiga" className="text-black">Ertiga / Rumion</option>
              <option value="innova" className="text-black">Innova Crysta</option>
            </select>
          </div>
        </div>
        ...
        <div className="bg-[#020617] border border-gray-700 rounded-2xl px-4 py-4 mb-5">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-green-500/10 flex items-center justify-center">⏰</div>
            <div className="flex-1">
              <p className="text-xs text-gray-400 mb-1">Select Time</p>
              <TimePicker
                value={selectedTime}
        ...
        <p className="text-xs text-gray-400 mt-4 text-center">✔ No hidden charges • ✔ Free cancellation</p>
      </div>
    </>
  );
}
