      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        {rides.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-500 mt-4">No rides yet. Book your first ride!</p>
            <Link
              to="/book"
              className="inline-block mt-4 bg-gray-900 text-white px-6 py-2 rounded-xl text-sm font-medium"
            >
              Book a Ride
            </Link>
          </div>
